...
console.log("'dermatoglyphics':", isHeterogram("dermatoglyphics")); 
console.log("'hello':", isHeterogram("hello")); 
console.log("'Alphabet':", isHeterogram("Alphabet")); 
console.log("'thumbscrew':", isHeterogram("thumbscrew")); 
...
console.log("'triangle' and 'integral':", areAnagrams("triangle", "integral")); 
